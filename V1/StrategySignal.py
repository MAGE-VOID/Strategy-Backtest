...
class StrategySignal:
    def __init__(self, InputData, manipulation_threshold=0.8, manipulation_weight=0.8):
        ...
        self.manipulation_threshold = manipulation_threshold  # Factor para definir manipulación
        self.manipulation_weight = manipulation_weight  # Peso reducido para velas manipuladas
    ...
    def generate_signals(self):
        ...
        for i in range(0, self.required_data_length - 10, 10):
            ...
            price_diff_pct = ((open_prices[i + 10] - open_prices[i]) / open_prices[i]) * 100
        ...
        for i in range(0, self.required_data_length - 10, 10):
            ...
            if self.is_manipulated(price_diff_pct, mean_diff_pct):
                price_diff_pct *= self.manipulation_weight  # Reducimos el impacto si es manipulada
